...
export class ChangeColumns1628690647941 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction_history" ADD "item" character varying NOT NULL`
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_history" ADD "balance" money NOT NULL`
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_history" ADD "type" character varying NOT NULL`
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_history" ADD "total" money NOT NULL`
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_history" DROP COLUMN "projectId"`
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction_history" ADD "projectId" integer NOT NULL`
    );
    await queryRunner.query(
      `ALTER TABLE "transaction_history" ADD "amount" integer NOT NULL`
    );
  }
}
