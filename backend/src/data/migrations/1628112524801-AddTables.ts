...
export class AddTables1628112524801 implements MigrationInterface {
    name = 'AddTables1628112524801'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "project" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" text NOT NULL, "description" text NOT NULL, "isActive" boolean NOT NULL DEFAULT true, "goal" money NOT NULL, "startDate" TIMESTAMP NOT NULL, "finishDate" TIMESTAMP NOT NULL, "totalViews" integer NOT NULL, "minutesToRead" integer NOT NULL, "totalInteractionTime" integer NOT NULL, "region" text NOT NULL, "categoryId" uuid, "teamId" uuid, CONSTRAINT "REL_d0474b642dc0ae63660dd8e2ac" UNIQUE ("teamId"), CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "donate" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "amount" money NOT NULL, "userId" uuid, "projectId" uuid, CONSTRAINT "PK_aa34cd4d591755337f6f3fd6c50" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "achievement" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "description" text NOT NULL, "goal" money NOT NULL, CONSTRAINT "PK_441339f40e8ce717525a381671e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "donators_privilege" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "privilege" text NOT NULL, "amount" money NOT NULL, CONSTRAINT "PK_c6eeeb5c492db953883d44f86db" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "user_profile" ADD "balance" money NOT NULL`);
