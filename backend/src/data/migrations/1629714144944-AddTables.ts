...
export class AddTables1629714144944 implements MigrationInterface {
    name = 'AddTables1629714144944'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "alerts_settings_frequency_enum" AS ENUM('0', '1', '2', '3', '4', '5', '6', '7')`);
        await queryRunner.query(`CREATE TABLE "alerts_settings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "frequency" "alerts_settings_frequency_enum" NOT NULL DEFAULT '0', "isActive" boolean NOT NULL DEFAULT false, "time" TIMESTAMP NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "REL_3855681ab0de61ff62a3912451" UNIQUE ("userId"), CONSTRAINT "PK_9d3e79f8664955c374c0170379b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "comment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "message" text NOT NULL, "projectId" uuid, "authorId" uuid, "parentCommentId" uuid, CONSTRAINT "PK_0b0e4bbc8415ec426f87f3a88e2" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "donate" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "amount" numeric NOT NULL, "userId" uuid, "projectId" uuid, CONSTRAINT "PK_aa34cd4d591755337f6f3fd6c50" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "donators_privilege" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "title" text NOT NULL, "content" text NOT NULL, "includes" text array NOT NULL, "amount" numeric NOT NULL, CONSTRAINT "PK_c6eeeb5c492db953883d44f86db" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tag" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" text NOT NULL, "authorId" uuid, CONSTRAINT "UQ_6a9775008add570dc3e5a0bab7b" UNIQUE ("name"), CONSTRAINT "PK_8e4052373c579afc1471f526760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_project" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "isWatched" boolean NOT NULL DEFAULT false, "isFavorite" boolean NOT NULL DEFAULT false, "mark" "user_project_mark_enum" NOT NULL, "userId" uuid, "projectId" uuid, CONSTRAINT "PK_72a40468c3924e43b934542e8e4" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "project" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "name" text NOT NULL, "description" text NOT NULL, "content" character varying, "isActive" boolean NOT NULL DEFAULT true, "goal" numeric NOT NULL, "startDate" TIMESTAMP NOT NULL, "finishDate" TIMESTAMP NOT NULL, "totalViews" integer NOT NULL DEFAULT '0', "minutesToRead" real NOT NULL DEFAULT '0', "totalInteractionTime" real NOT NULL DEFAULT '0', "region" text NOT NULL, "imageUrl" text, "instagramUrl" text, "facebookUrl" text, "dribbleUrl" text, "teamId" uuid, "categoryId" uuid, "authorId" uuid, CONSTRAINT "REL_d0474b642dc0ae63660dd8e2ac" UNIQUE ("teamId"), CONSTRAINT "PK_4d68b1358bb5b766d3e78f32f57" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_profile" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "email" character varying NOT NULL, "phoneNumber" character varying, "balance" numeric NOT NULL DEFAULT '0', "rating" numeric NOT NULL DEFAULT '0', "lastLoginDate" TIMESTAMP NOT NULL DEFAULT now(), "description" character varying, "region" character varying, "gender" character varying, "birthday" character varying, "imageUrl" text, "instagramUrl" character varying, "facebookUrl" character varying, "dribbleUrl" character varying, "alertsSettingsId" uuid, CONSTRAINT "REL_29ccc1a897bbc6530cc88e8a99" UNIQUE ("alertsSettingsId"), CONSTRAINT "PK_f44d0cd18cfd80b0fed7806c3b7" PRIMARY KEY ("id"))`);
